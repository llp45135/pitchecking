...
public class FaceCheckingService {
	...
	public FaceData pollPassedFaceData() throws InterruptedException{
		
		//Config.getInstance().getGetFaceCheckDelayTime();
		FaceData fd = passedFaceDataQueue.poll(Config.getInstance().getGetFaceCheckDelayTime(),TimeUnit.MILLISECONDS );
		return fd;
	}
