...
public class PITEventTopicSender implements Runnable {
	...
	private Log log = LogFactory.getLog("PITEventTopicSender");

	private LinkedBlockingQueue<String> infoQueue;

	public PITEventTopicSender(LinkedBlockingQueue<String> q) {
		infoQueue = q;
		this.connectMQ();
	}
