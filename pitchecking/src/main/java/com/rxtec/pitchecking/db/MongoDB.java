...
public class MongoDB {
	...
	private MongoDB() {
		String uri = "mongodb://pitcheck_writer:PitcheckWriter61336956@localhost:27017/?authSource=pitcheck";
	...
	public void save(PITVerifyData data, boolean isPassed) {
		...
		if (isPassed)
			passedCollections.insertOne(rec);
		else
			failedCollections.insertOne(rec);
